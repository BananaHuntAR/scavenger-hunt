...
global.THREE = THREE; //make THREE a global variable so OBJLoader in utils can add method
...
class Game extends React.Component {
  ...
  _onGLContextCreate = async gl => {
    ...
    let onProgress = function(e){console.log("rendering banana:" + Object.values(e.type))}; //just for error checking
    let onError = function(e){console.log("error loading banana:" + Object.values(e.type))}; //just for error checking
